...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-xl-12 col-lg-12 col-sm-12">
            <h1 class="text-center satisfy mt-5">Política de privacidad</h1>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-xl-12 col-lg-12 col-sm-12">
            <p>La presente Política de Privacidad establece los términos en que Carbon y Brasas usa y protege la
            ...
            <p>Carbon y Brasas está altamente comprometido para cumplir con el compromiso de mantener su
            ...
            <p>Carbon y Brasas Se reserva el derecho de cambiar los términos de la presente Política de Privacidad
