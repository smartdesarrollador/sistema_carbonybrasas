...
!function (a) {
    ...
    }, "Please specify a valid phod."), a.validator.addMethod("phonePL", function (a, b) {
        a = a.replace(/\s+/g, "");
        var c = /^(?:(?:(?:\+|00)?48)|(?:\(\+?48\)))?(?:1[2-8]|2[2-69]|3[2-49]|4[1-68]|5[0-9]|6[0-35-9]|[7-8][1-9]|9[145])\d{7}$/;
        return this.optional(b) || c.test(a)
    }, "Numero Invalido"), a.validator.addMethod("phonesUK", function (a, b) {
    ...
    }, "Numero Inválido"), a.validator.addMethod("phoneUS", function (a, b) {
        return a = a.replace(/\s+/g, ""), this.optional(b) || a.length > 9 && a.match(/^(\+?1-?)?(\([2-9]([02-9]\d|1[02-9])\)|[2-9]([02-9]\d|1[02-9]))-?[2-9]\d{2}-?\d{4}$/)
    }, "Numero Inválido"), a.validator.addMethod("postalcodeBR", function (a, b) {
